(() => {
  ...
  // assets/admin/css/vendor.css
  var require_vendor = __commonJS({
    "assets/admin/css/vendor.css"(exports, module) {
      module.exports = {};
    }
  });
  ...
  var require_bootstrap_notify = __commonJS({
    "node_modules/bootstrap-notify/bootstrap-notify.js"(exports) {
      (function(factory) {
        if (typeof define === "function" && define.amd) {
        ...
        function Notify(element, content, options) {
          ...
          options = $2.extend(true, {}, content, options);
          this.settings = $2.extend(true, {}, defaults, options);
        ...
        $2.extend(Notify.prototype, {
            ...
            this.notify = {
              ...
              update: function(command, update) {
                ...
                for (var command in commands) {
                  switch (command) {
                    case "type":
                      this.$ele.removeClass("alert-" + self2.settings.type);
                      this.$ele.find('[data-notify="progressbar"] > .progress-bar').removeClass("progress-bar-" + self2.settings.type);
                      self2.settings.type = commands[command];
                      this.$ele.addClass("alert-" + commands[command]).find('[data-notify="progressbar"] > .progress-bar').addClass("progress-bar-" + commands[command]);
                      break;
                    case "icon":
                      var $icon = this.$ele.find('[data-notify="icon"]');
                      if (self2.settings.icon_type.toLowerCase() == "class") {
                        $icon.removeClass(self2.settings.content.icon).addClass(commands[command]);
                      } else {
                        if (!$icon.is("img")) {
                          $icon.find("img");
                        }
                      ...
                      break;
                    case "progress":
                      var newDelay = self2.settings.delay - self2.settings.delay * (commands[command] / 100);
                ...
                var posX = this.$ele.outerHeight() + parseInt(self2.settings.spacing) + parseInt(self2.settings.offset.y);
                self2.reposition(posX);
              },
              close: function() {
                self2.close();
              }
          ...
          buildNotify: function() {
            ...
            this.$ele = $2(String.format(this.settings.template, this.settings.type, content.title, content.message, content.url, content.target));
          ...
          placement: function() {
            var self2 = this, offsetAmt = this.settings.offset.y, css = {
            ...
            $2('[data-notify-position="' + this.settings.placement.from + "-" + this.settings.placement.align + '"]:not([data-closing="true"])').each(function() {
              return offsetAmt = Math.max(offsetAmt, parseInt($2(this).css(settings.placement.from)) + parseInt($2(this).outerHeight()) + parseInt(settings.spacing));
            });
            ...
            $2.each(Array("webkit-", "moz-", "o-", "ms-", ""), function(index, prefix) {
              self2.$ele[0].style[prefix + "AnimationIterationCount"] = 1;
            });
            $2(this.settings.element).append(this.$ele);
            if (this.settings.newest_on_top == true) {
              offsetAmt = parseInt(offsetAmt) + parseInt(this.settings.spacing) + this.$ele.outerHeight();
              this.reposition(offsetAmt);
            }
            if ($2.isFunction(self2.settings.onShow)) {
              self2.settings.onShow.call(this.$ele);
            }
            this.$ele.one(this.animations.start, function(event) {
              hasAnimation = true;
            }).one(this.animations.end, function(event) {
              if ($2.isFunction(self2.settings.onShown)) {
                self2.settings.onShown.call(this);
              }
            });
            setTimeout(function() {
              if (!hasAnimation) {
          ...
          bind: function() {
            ...
            this.$ele.mouseover(function(e) {
              $2(this).data("data-hover", "true");
            }).mouseout(function(e) {
              $2(this).data("data-hover", "false");
            });
            this.$ele.data("data-hover", "false");
            if (this.settings.delay > 0) {
              self2.$ele.data("notify-delay", self2.settings.delay);
              var timer = setInterval(function() {
                var delay = parseInt(self2.$ele.data("notify-delay")) - self2.settings.timer;
                if (self2.$ele.data("data-hover") === "false" && self2.settings.mouse_over == "pause" || self2.settings.mouse_over != "pause") {
                  var percent = (self2.settings.delay - delay) / self2.settings.delay * 100;
                  self2.$ele.data("notify-delay", delay);
                  self2.$ele.find('[data-notify="progressbar"] > div').attr("aria-valuenow", percent).css("width", percent + "%");
                }
                if (delay <= -self2.settings.timer) {
                  clearInterval(timer);
                  self2.close();
                }
              }, self2.settings.timer);
            }
          },
          close: function() {
            var self2 = this, $successors = null, posX = parseInt(this.$ele.css(this.settings.placement.from)), hasAnimation = false;
            this.$ele.data("closing", "true").addClass(this.settings.animate.exit);
            self2.reposition(posX);
            if ($2.isFunction(self2.settings.onClose)) {
              self2.settings.onClose.call(this.$ele);
            }
            this.$ele.one(this.animations.start, function(event) {
              hasAnimation = true;
            }).one(this.animations.end, function(event) {
              $2(this).remove();
              if ($2.isFunction(self2.settings.onClosed)) {
                self2.settings.onClosed.call(this);
              }
            });
            setTimeout(function() {
              if (!hasAnimation) {
                self2.$ele.remove();
                if (self2.settings.onClosed) {
                  self2.settings.onClosed(self2.$ele);
                }
              }
            }, 600);
          },
          reposition: function(posX) {
            var self2 = this, notifies = '[data-notify-position="' + this.settings.placement.from + "-" + this.settings.placement.align + '"]:not([data-closing="true"])', $elements = this.$ele.nextAll(notifies);
            if (this.settings.newest_on_top == true) {
              $elements = this.$ele.prevAll(notifies);
            }
            $elements.each(function() {
              $2(this).css(self2.settings.placement.from, posX);
              posX = parseInt(posX) + parseInt(self2.settings.spacing) + $2(this).outerHeight();
            });
          }
        });
        $2.notify = function(content, options) {
          var plugin = new Notify(this, content, options);
          return plugin.notify;
        };
        $2.notifyDefaults = function(options) {
          defaults = $2.extend(true, {}, defaults, options);
          return defaults;
        };
        $2.notifyClose = function(command) {
          if (typeof command === "undefined" || command == "all") {
            $2("[data-notify]").find('[data-notify="dismiss"]').trigger("click");
          } else {
            $2('[data-notify-position="' + command + '"]').find('[data-notify="dismiss"]').trigger("click");
          }
        };
      });
    }
  ...
  var require_jquery_scrollbar = __commonJS({
    "node_modules/jquery.scrollbar/jquery.scrollbar.js"(exports) {
      (function(root, factory) {
        ...
        browser.scrolls.remove = function(instance) {
          while ($2.inArray(instance, this) >= 0) {
            this.splice($2.inArray(instance, this), 1);
          }
          return this;
        };
        var defaults = {
          ...
          onUpdate: null
          // callback function on init/resize (before scrollbar size calculation)
        };
        var BaseScrollbar = function(container) {
          ...
          this.options = $2.extend({}, defaults, window.jQueryScrollbarOptions || {});
          this.scrollTo = null;
          this.scrollx = {};
          this.scrolly = {};
        ...
        BaseScrollbar.prototype = {
          destroy: function() {
            ...
            this.wrapper.remove();
            $2(document).add("body").off(this.namespace);
            if ($2.isFunction(this.options.onDestroy)) {
              this.options.onDestroy.apply(this, [this.container]);
            }
          },
          init: function(options) {
            var S = this, c = this.container, cw = this.containerWrapper || c, namespace = this.namespace, o = $2.extend(this.options, options || {}), s = { x: this.scrollx, y: this.scrolly }, w = this.wrapper, cssOptions = {};
            var initScroll = {
              scrollLeft: c.scrollLeft(),
              scrollTop: c.scrollTop()
            };
            if (browser.mobile && o.ignoreMobile || browser.overlay && o.ignoreOverlay || browser.macosx && !browser.webkit) {
              if ($2.isFunction(o.onFallback)) {
                o.onFallback.apply(this, [c]);
              }
              return false;
            }
            if (!w) {
              this.wrapper = w = $2("<div>").addClass("scroll-wrapper").addClass(c.attr("class")).css("position", c.css("position") === "absolute" ? "absolute" : "relative").insertBefore(c).append(c);
              if (o.isRtl) {
                w.addClass("scroll--rtl");
              }
              if (c.is("textarea")) {
                this.containerWrapper = cw = $2("<div>").insertBefore(c).append(c);
              ...
              if (o.disableBodyScroll) {
                ...
                if (browser.mobile) {
                  w.on("touchstart" + namespace, function(event) {
                    ...
                    $2(document).on("touchmove" + namespace, function(event2) {
                      var touch2 = event2.originalEvent.targetTouches && event2.originalEvent.targetTouches[0] || event2;
                      c.scrollLeft(originalScroll.left + originalTouch.pageX - touch2.pageX);
                      c.scrollTop(originalScroll.top + originalTouch.pageY - touch2.pageY);
                      event2.preventDefault();
                    });
                    $2(document).on("touchend" + namespace, function() {
                      $2(document).off(namespace);
                    });
                  });
                }
              }
              if ($2.isFunction(o.onInit)) {
            ...
            $2.each(s, function(d, scrollx) {
              ...
              if (!scrollx.scroll) {
                ...
                scrollx.scroll.find(".scroll-arrow, .scroll-element_track").on("mousedown" + namespace, function(event) {
                  ...
                  if ($2(this).hasClass("scroll-arrow")) {
                    scrollForward = $2(this).hasClass("scroll-arrow_more") ? 1 : -1;
                ...
                scrollx.scroll.bar.on("mousedown" + namespace, function(event) {
                  ...
                  $2(document).on("mousemove" + namespace, function(event2) {
                    var diff = parseInt((event2[d === "x" ? "pageX" : "pageY"] - eventPosition) / scrollx.kx, 10);
                    if (d === "x" && o.isRtl && (browser.msie || browser.msedge))
                      diff = diff * -1;
          ...
          _getScroll: function(scroll) {
            ...
            if (typeof scroll == "string") {
              scroll = $2(scroll).appendTo(this.wrapper);
            } else {
              scroll = $2(scroll);
            }
            $2.extend(scroll, {
          ...
          _handleMouseDown: function(callback, event) {
            ...
            $2(document).on("blur" + namespace, function() {
              $2(document).add("body").off(namespace);
              callback && callback();
            });
            $2(document).on("dragstart" + namespace, function(event2) {
              event2.preventDefault();
              return false;
            });
            $2(document).on("mouseup" + namespace, function() {
              $2(document).add("body").off(namespace);
              callback && callback();
            });
            $2("body").on("selectstart" + namespace, function(event2) {
              event2.preventDefault();
              return false;
            });
          ...
          _updateScroll: function(d, scrollx) {
            ...
            if (scrollx.size != container.prop("scrollWidth") || scrolly.size != container.prop("scrollHeight") || scrollx.visible != wrapper.width() || scrolly.visible != wrapper.height() || scrollx.offset != (parseInt(container.css("left"), 10) || 0) || scrolly.offset != (parseInt(container.css("top"), 10) || 0)) {
              $2.extend(this.scrollx, {
                offset: parseInt(container.css("left"), 10) || 0,
                size: container.prop("scrollWidth"),
                visible: wrapper.width()
              });
              $2.extend(this.scrolly, {
        ...
        $2.fn.scrollbar = function(command, args) {
          if (typeof command !== "string") {
            args = command;
            command = "init";
          }
          ...
          this.not("body, .scroll-wrapper").each(function() {
            var element = $2(this), instance = element.data(browser.data.name);
        ...
        $2.fn.scrollbar.options = defaults;
        var updateScrollbars = /* @__PURE__ */ function() {
        ...
        function getBrowserScrollSize(actualSize) {
          ...
          if (!browser.data.outer) {
            ...
            browser.data.inner = $2("<div>").css($2.extend({}, css));
            browser.data.outer = $2("<div>").css($2.extend({
              "left": "-1000px",
              "overflow": "scroll",
              "position": "absolute",
              "top": "-1000px"
          ...
          browser.data.outer.scrollLeft(1e3).scrollTop(1e3);
          return {
  ...
  var require_jquery2 = __commonJS({
    "node_modules/jquery.scrollbar/index.js"(exports, module) {
      require_jquery_scrollbar();
      module.exports = "jQueryScrollbar";
    }
  });

  // assets/admin/js/kaiadmin/kaiadmin.js
  var require_kaiadmin = __commonJS({
    "assets/admin/js/kaiadmin/kaiadmin.js"() {
      "use strict";
      ...
      $(document).ready(function() {
        ...
        var toggle_sidebar = false, toggle_quick_sidebar = false, toggle_topbar = false, minimize_sidebar = false, first_toggle_sidebar = false, toggle_page_sidebar = false, toggle_overlay_sidebar = false, nav_open = 0, quick_sidebar_open = 0, topbar_open = 0, mini_sidebar = 0, page_sidebar_open = 0, overlay_sidebar_open = 0;
        if (!toggle_sidebar) {
